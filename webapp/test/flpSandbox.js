		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Cursos",
									"targetURL": "#zcursorvmapp2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zcursorvmapp2-display": {
								"semanticObject": "zcursorvmapp2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zcursorvmapp2",
									"url": sap.ui.require.toUrl("zcursorvmapp2")
								}
							}
						}
					}
